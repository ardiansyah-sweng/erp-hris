...
<div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-shadow duration-300">
    ...
    <div class="px-6 py-5 border-b border-gray-100 flex justify-between items-center">
        ...
        <div class="flex items-center gap-3">
            ...
            <!-- Dropdown Sorting -->
            @php
                $nextSort = ($sort ?? 'asc') == 'asc' ? 'desc' : 'asc';
            @endphp

            <a href="{{ route('employees.index', ['sort' => $nextSort]) }}"
                class="inline-flex items-center justify-center w-10 h-10 rounded-xl border border-gray-200 bg-white text-gray-600 shadow-sm transition hover:bg-gray-50"
                title="Sort">
